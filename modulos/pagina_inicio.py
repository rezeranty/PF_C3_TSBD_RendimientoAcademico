...
def pagina_inicio():
    try:
        logo = Image.open("modulos/img/logo_tec.png")
    ...
    <div class='button-container'>
        ...
        <a href='https://www.tecazuay.edu.ec/carrera-tecnologia-superior-en-big-data/' target='_blank' class='custom-button'>
    ...
    eduardo_img = get_image_base64("modulos/img/Eduardo Mendieta.jpg")
    anthony_img = get_image_base64("modulos/img/Anthony Rosillo.jpg")
    justin_img = get_image_base64("modulos/img/Justin Escalante.jpg")
    evelyn_img = get_image_base64("modulos/img/Evelyn Criollo.jpg")

    team_members_data = [
        ("Eduardo Mendieta", "edwmn01", eduardo_img),
        ("Anthony Rosillo", "rezeranty", anthony_img),
        ("Justin Escalante", "KYOUKO-002", justin_img),
        ("Evelyn Criollo", "Nidddddddd", evelyn_img)
    ]

    cols_display = st.columns(len(team_members_data)) 

    for i, (name, github, img) in enumerate(team_members_data):
        with cols_display[i]:
            st.markdown(f"""
            <div class='team-card'>
                <div class='profile-image'>
                    <img src='data:image/jpg;base64,{img}' alt='{name}' />
                </div>
